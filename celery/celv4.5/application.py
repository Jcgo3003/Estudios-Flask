# Esta version intentara alimentar a long task con informacion de exterior
...
# esta es la seccion que llara a  'longtask'
...
# status la parte de flask que se encargara de enviar/recibir los estados
...
def estado():
    if request.method == 'POST':
        ...
        dire = int(request.headers.get('dire'))
        print('Dire:', dire )

        task = long_task( 'Nule' , dire, sensor)
        return 'ok'

if __name__ == '__main__':
    app.run(debug=True)

# Exploto no sirve estoy mal